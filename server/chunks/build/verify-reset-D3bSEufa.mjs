...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    try {
      const { data, error } = ([__temp, __restore] = withAsyncContext(() => verifyReset(token)), __temp = await __temp, __restore(), __temp);
      if (error)
        navigateTo("/auth/verify-failed");
      if (data)
        navigateTo(`/auth/verify-reset-success?pass=${data.pass}`);
    } catch (e) {
      resetError.value = {};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/auth/verify-reset.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=verify-reset-D3bSEufa.mjs.map
