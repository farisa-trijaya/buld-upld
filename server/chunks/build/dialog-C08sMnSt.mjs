...
import { ref, defineComponent, h as h$1, computed, onMounted, onUnmounted, watchEffect, watch, provide, normalizeClass, Fragment, unref, inject, getCurrentInstance, Teleport, reactive, cloneVNode, nextTick, shallowRef } from 'vue';
import { d as defineStore, s as storages } from './server.mjs';
import { am as v4 } from '../runtime.mjs';
...
const useCartStore = defineStore(
  ...
  () => {
    ...
    function removeFromCart(item) {
      let itemFound = items.value.find((i2) => item.sku == i2.sku);
      if (itemFound) {
        items.value = items.value.filter((i2) => item.sku !== i2.sku);
      }
      getTotalPrice();
    }
    ...
    function addShippingInfo(data) {
      shippingInfo.value.push({ ...data, id: v4() });
    }
    function editShippingInfo(id, data) {
      shippingInfo.value = shippingInfo.value.filter((i2) => id !== i2.id);
      shippingInfo.value.push({ ...data, id: v4() });
    }
    function removeShippingInfo(id) {
      shippingInfo.value = shippingInfo.value.filter((i2) => id !== i2.id);
    }
...
var i$4 = ((e2) => (e2[e2.Open = 1] = "Open", e2[e2.Closed = 2] = "Closed", e2[e2.Closing = 4] = "Closing", e2[e2.Opening = 8] = "Opening", e2))(i$4 || {});
function s$3() {
  return l$2() !== null;
}
function l$2() {
...
var d$4 = (t2, e2, r2) => e2 in t2 ? i$3(t2, e2, { enumerable: true, configurable: true, writable: true, value: r2 }) : t2[e2] = r2;
...
function L$1(e2, t2, i2, n2, a2, l2) {
  let s3 = o$1(), o2 = l2 !== void 0 ? l$1(l2) : () => {
  };
  return d$3(e2, ...a2), m$2(e2, ...t2, ...i2), s3.nextFrame(() => {
    d$3(e2, ...i2), m$2(e2, ...n2), s3.add(F$1(e2, (u2) => (d$3(e2, ...n2, ...t2), m$2(e2, ...a2), o2(u2))));
  }), s3.add(() => d$3(e2, ...t2, ...i2, ...n2, ...a2)), s3.add(() => o2("cancelled")), s3.dispose;
}
function g(e2 = "") {
  return e2.split(/\s+/).filter((t2) => t2.length > 1);
}
let R$1 = Symbol("TransitionContext");
var pe = ((a2) => (a2.Visible = "visible", a2.Hidden = "hidden", a2))(pe || {});
function me() {
  return inject(R$1, null) !== null;
}
function Te$1() {
  let e2 = inject(R$1, null);
  if (e2 === null)
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  return e2;
}
function ge() {
  let e2 = inject(N$3, null);
  if (e2 === null)
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  return e2;
}
let N$3 = Symbol("NestingContext");
function L(e2) {
...
let W$1 = N$4.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s3, expose: h2 }) {
  ...
  h2({ el: d2, $el: d2 });
  let { show: v2, appear: A2 } = Te$1(), { register: D, unregister: H2 } = ge(), i2 = ref(v2.value ? "visible" : "hidden"), I2 = { value: true }, c2 = i$5(), b2 = { value: false }, P2 = Q(() => {
  ...
  return onMounted(() => {
  ...
  }), provide(N$3, P2), t$4(computed(() => u$5(i2.value, { ["visible"]: i$4.Open, ["hidden"]: i$4.Closed }) | n2.value)), () => {
    ...
    return A$2({ theirProps: re, ourProps: ne, slot: {}, slots: s3, attrs: a2, features: W$1, visible: i2.value === "visible", name: "TransitionChild" });
  };
  ...
  }), provide(N$3, l2), provide(R$1, S2), () => {
    let d2 = T$2(e2, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), y2 = { unmount: e2.unmount };
    return A$2({ ourProps: { ...y2, as: "template" }, theirProps: {}, slot: {}, slots: { ...s3, default: () => [h$1(ce, { onBeforeEnter: () => t2("beforeEnter"), onAfterEnter: () => t2("afterEnter"), onBeforeLeave: () => t2("beforeLeave"), onAfterLeave: () => t2("afterLeave"), ...a2, ...y2, ...d2 }, s3.default)] }, attrs: {}, features: W$1, visible: r2.value === "visible", name: "Transition" });
  };
} });
...
function P(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o2 = [] } = {}) {
  var m2;
  let i2 = (m2 = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : void 0 : e2 == null ? void 0 : e2.ownerDocument) != null ? m2 : void 0, n2 = Array.isArray(e2) ? t2 ? O(e2) : e2 : E$1(e2);
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n2, slots: r2, expose: l2 }) {
  let o2 = ref(null);
  l2({ el: o2, $el: o2 });
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$1(T2, d2) || (s3.value ? P(o$2(o2), u$5(f2.value, { [d$2.Forwards]: () => N$2.Next, [d$2.Backwards]: () => N$2.Previous }) | N$2.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
    let u2 = {}, T2 = { ref: o2, onKeydown: F2, onFocusout: H2 }, { features: d2, initialFocus: w2, containers: Q2, ...O2 } = t2;
    return h$1(Fragment, [Boolean(d2 & 4) && h$1(f$1, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$4.Focusable }), A$2({ ourProps: T2, theirProps: { ...n2, ...O2 }, slot: u2, attrs: n2, slots: r2, name: "FocusTrap" }), Boolean(d2 & 4) && h$1(f$1, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$4.Focusable })]);
  };
} }), { features: A$1 });
function W(t2) {
  ...
  return onMounted(() => i2.value = true), onUnmounted(() => i2.value = false), onMounted(() => {
    watch([n2, r2, l2], (e2, m2) => {
      ...
      f2 && t$3(() => {
        ...
        a2 ? S(a2) : P(f2, N$2.First | N$2.NoScroll) === T$1.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), o2.value = (H2 = t2.value) == null ? void 0 : H2.activeElement;
      });
...
function J({ ownerDocument: t2, container: n2, containers: r2, previousActiveElement: l2 }, o2) {
  ...
  E$2((i2 = t2.value) == null ? void 0 : i2.defaultView, "focus", (e2) => {
    ...
    if (!f2)
      return;
    let a2 = e2.target;
    a2 && a2 instanceof HTMLElement ? N$1(m2, a2) ? (l2.value = a2, S(a2)) : (e2.preventDefault(), e2.stopPropagation(), S(f2)) : S(l2.value);
  }, true);
}
function N$1(t2, n2) {
  for (let r2 of t2)
...
let a = a$1(() => /* @__PURE__ */ new Map(), { PUSH(e2, n2) {
  ...
  let o2 = { doc: e2, d: n2, meta: m(t2) }, c$12 = [w$2(), c(), l()];
...
function w$1(f2, m2, l2 = computed(() => true)) {
  ...
  }, true), u$3("touchend", (e2) => a2(e2, () => e2.target instanceof HTMLElement ? e2.target : null), true), w$4("blur", (e2) => a2(e2, () => (void 0).document.activeElement instanceof HTMLIFrameElement ? (void 0).document.activeElement : null), true);
}
...
let $ = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e2, { slots: t2, attrs: l2 }) {
  let r2 = ref(null), i2 = computed(() => i$2(r2)), o2 = s$1(), u2 = inject(H$1, null), n2 = ref(o2 === true || u2 == null ? x(r2.value) : u2.resolveTarget());
  ...
  let v2 = inject(d, null), g2 = false, b2 = getCurrentInstance();
  return watch(r2, () => {
    if (g2 || !v2)
      return;
    let a2 = o$2(r2);
...
let A = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p, expose: s$12 }) {
  ...
  let r2 = false, g2 = computed(() => t2.role === "dialog" || t2.role === "alertdialog" ? t2.role : (r2 || (r2 = true, console.warn(`Invalid role [${g2}] passed to <Dialog />. Only \`dialog\` and and \`alertdialog\` are supported. Using \`dialog\` instead.`)), "dialog")), D = ref(0), S2 = l$2(), R$12 = computed(() => t2.open === A && S2 !== null ? (S2.value & i$4.Open) === i$4.Open : t2.open), m2 = ref(null), E$12 = computed(() => i$2(m2));
  if (s$12({ el: m2, $el: m2 }), !(t2.open !== A || S2 !== null))
    throw new Error("You forgot to provide an `open` prop to the `Dialog`.");
  if (typeof R$12.value != "boolean")
    throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${R$12.value === A ? void 0 : t2.open}`);
  let c2 = computed(() => u2.value && R$12.value ? 0 : 1), k$1 = computed(() => c2.value === 0), w2 = computed(() => D.value > 1), N$12 = inject(H, null) !== null, [Q2, X] = q(), { resolveContainers: B2, mainTreeNodeRef: K, MainTreeNode: Z } = N({ portals: Q2, defaultContainers: [computed(() => {
    var e2;
    return (e2 = h2.panelRef.value) != null ? e2 : m2.value;
  })] }), ee = computed(() => w2.value ? "parent" : "leaf"), U2 = computed(() => S2 !== null ? (S2.value & i$4.Closing) === i$4.Closing : false), te = computed(() => N$12 || U2.value ? false : k$1.value), le = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$12.value) == null ? void 0 : e2.querySelectorAll("body > *")) != null ? a2 : []).find((f2) => f2.id === "headlessui-portal-root" ? false : f2.contains(o$2(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E(le, te);
  let ae = computed(() => w2.value ? true : k$1.value), oe = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$12.value) == null ? void 0 : e2.querySelectorAll("[data-headlessui-portal]")) != null ? a2 : []).find((f2) => f2.contains(o$2(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E(oe, ae), R({ type: "Dialog", enabled: computed(() => c2.value === 0), element: m2, onUpdate: (e2, a2) => {
    if (a2 === "Dialog")
      return u$5(e2, { [s2.Add]: () => D.value += 1, [s2.Remove]: () => D.value -= 1 });
  } });
  let re = k({ name: "DialogDescription", slot: computed(() => ({ open: R$12.value })) }), M2 = ref(null), h2 = { titleId: M2, panelRef: ref(null), dialogState: c2, setTitleId(e2) {
  ...
  E$2((W2 = E$12.value) == null ? void 0 : W2.defaultView, "keydown", (e2) => {
...
export { A$2 as A, Ge as G, N$4 as N, O, P, Se as S, T$2 as T, Ye as Y, u$4 as a, u$5 as b, o as c, T$1 as d, i$2 as e, f$1 as f, N$2 as g, he as h, i$5 as i, o$2 as o, t$3 as t, useCartStore as u };
//# sourceMappingURL=dialog-C08sMnSt.mjs.map
